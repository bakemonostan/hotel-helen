          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen py-20">
            ...
            <div className="text-white space-y-6 lg:space-y-8 order-2 lg:order-1">
              <motion.div
                ...
                <motion.p
                  className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-2xl leading-relaxed"
              ...
              <motion.div
                ...
                <Button className="bg-amber-600 hover:bg-amber-700 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-semibold group transition-all duration-300 transform hover:scale-105">
                  Explore Rooms
                  <ArrowRight
                    size={18}
                ...
                <Button
                  variant="outline"
                  className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-gray-800 px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-semibold transition-all duration-300">
                  Read About Us
                </Button>
              </motion.div>
